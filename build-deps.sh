...
./sync.sh https://github.com/skyhuppa/Kernel_Infinix_X573_test.git "data/kernel" "${REF}" &
# ./sync.sh https://github.com/skyhuppa/android_kernel_lenovo_msm8937.git "data/kernel" "${REF}" &
# ./sync.sh https://github.com/skyhuppa/nabu.git "data/kernel" "${REF}" &
PIDS="${PIDS} $!"
